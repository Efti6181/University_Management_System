...
?> 
 ...
 $sql="select name,dept,designation,pic from teacher where tid='$sid'";
...
<head>
  <meta charset="UTF-8">
  <title>University Management System - Faculty</title>
  <style>
    body {
      margin: 0;
...
<body>
  ...
  <div class="sidebar">
    ...
    <h2>Faculty Panel</h2>
    <ul class="nav-links">
      <li><a href="fpp.php" class="">👤 My Profile</a></li>
      <li><a href="cour.php" class="">🖥️ Select Course</a></li>
      <li><a href="mycour.php">📚 My Selected Courses</a></li>
      <li><a href="rout.php">📅 My Class Schedule</a></li>
      <li><a href="my_std.php">📝 My Student List</a></li>
...
echo "<div style='text-align: left; padding: 20px 0;'>
        <img src='../Admin/Timage/$image' style='width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 3px solid #ddd;'>
      </div>";    
?>
      <h1>Welcome, <?php echo "$name."; ?></h1><br>
      <h2>Faculty Member of Premier University Chittagong</h2>
      <h2>Faculty ID: <?php echo "$sid."; ?></h2>
      <h2><?php echo "$desig ,  "; ?>Department of <?php echo "$dept."; ?></h2>
