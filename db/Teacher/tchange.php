...
<h2 align='center'>Change Your Password</h2>
  <div class="container">
  <form action="tchange.php" method="post">
    <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    <a href="fpp.php" class="back-button">Back to Profile</a>
  </div>
...
if(isset($_POST['submit']))
{
	...
	if($npass==$cpass)
	{
	$sql="select password from teacher where password='$opass' and tid='$id'";
    $r=mysqli_query($con,$sql);
    if(mysqli_num_rows($r)>0)
    {
       $sql1="update teacher set password='$npass' where tid='$id'"; 
