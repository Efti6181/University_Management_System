...
if (isset($_SESSION['user_id'])) {
    ...
    $student_query = mysqli_query($con, "SELECT name FROM student WHERE id='$stid'");
    ...
    echo "<p style='color:red;text-align:center'>Please login to view your results.</p>";
    exit();
}
...
<body>
    ...
    <div class="all_student fix">
        ...
        <?php
                ...
                echo  "<p class='msg error'>No results found for this semester</p>";
            }
        }
        ?>
    </div>
