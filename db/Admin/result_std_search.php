...
<div class="search_result">		
    <table class="tab_one">
        ...
        <tr>
            ...
            <td>
                <a href="add_result.php?ar=<?php echo urlencode($rows['ID']); ?>&vn=<?php echo urlencode($rows['name']); ?>">
                    Publish Result
                </a>
            </td>
            <td>
                <a href="view_result.php?vr=<?php echo urlencode($rows['ID']); ?>&vn=<?php echo urlencode($rows['name']); ?>">
                    View Result
                </a>
            </td>
        </tr>
        ...
        ?>
        <div class="back fix">
            <p style="text-align:center"><a href="result_std.php"><button class="editbtn">Back to student list</button></a></p>
        </div>
</div>
</body>
</html>