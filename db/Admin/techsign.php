...
<body>
    ...
    <main class="main-container">
        <div class="page-title">
            <h2>Faculty Onboarding System</h2>
            <p>Complete the form below to register a new faculty member in the university system</p>
        </div>
...
<form class="form-body" action="techsign.php" method="post" enctype="multipart/form-data">
    <div class="form-section-title">Personal Information</div>
    <div class="form-grid">
        <!-- User ID -->
        <div class="form-group">
            <label class="form-label" for="tid">
        ...
        <!-- Designation -->
        <div class="form-group">
            <label class="form-label" for="des">
    ...
    <div class="submit-section">
        <input type="submit"  class="submit-btn" value="Add Faculty" name="submit">
        <!-- <span></span> -->
        <!-- <span>Submit</span> -->
    </div>
</form>
