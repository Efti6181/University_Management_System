...
<div class="all_student">
    <div class="search_st">
        ...
        <div class="search">
            <form action="search_fac.php" method="GET">
    ...
    <table class="tab_one">
        ...
        <tr>
            ...
            <td><a href="fac_details.php?vr=<?php echo urlencode($rows['tid']); ?>">View Details</a></td>
            <td><a href="fac_edit.php?tid=<?php echo urlencode($rows['tid']);?>" class="btn btn-sm btn-primary">Edit</a></td>
